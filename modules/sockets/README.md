...
## Создание событий
Процесс создания такой же как при создании методов в модуле API. Только в метод `getResponse` передаются либо экземпляр сокета, либо полученные данные с клиента, зависет от ветки запроса.
